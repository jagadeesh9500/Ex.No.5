...
5.  **Analyze:** Compare the four saved outputs against the metrics defined in Section 5.
...
This experiment provides a clear framework for quantitatively comparing modern prompting techniques. By analyzing the outputs for a complex, real-world task, you can gain practical insight into *how* to construct prompts to get high-quality, actionable results from an AI.

-----

## RESULT:

The procedure for a new, unique experiment comparing four distinct prompting patterns has been successfully designed and formatted for GitHub. The next step is to execute the tests and analyze the results.
